...
$(document).ready(function () {
  $('.slider .slider__images').slick({
      arrows: true, /*strelki*/
      slidesToShow: 3,/*kolichestvo slaidov kotoroe otobrajaetsya*/ 
      slidesToScroll: 1,
      appendArrows: $('.slider__inner-arrows'),
      infinite: true,
      variableWidth: true, /*ostavlyaet originalni razmer kartinki*/
       centerMode: true,
       centerPadding: '0px',
       initialSlide: 1, /* s kakoi kartinki nachinaetsya slaid*/
       waitForAnimate: true,
      speed: 1000,
      easing: 'ease',
      responsive: [
  ...
  $('.slider .slider__images').slick('setPosition'); 
});
